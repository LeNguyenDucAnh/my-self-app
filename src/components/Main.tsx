        ...
        <div>
          <div data-aos="fade-left" data-aos-duration="1000">
            <h1 className="py-4 text-gray-700">
              Hi, I&#39;m <span className="text-custom">Đức Anh</span>
            </h1>
            <h1 className="py-2 text-gray-700">A Front-End Developer</h1>
            <p className="py-4 text-gray-600 sm:max-w-[70%] m-auto text-lg">
              I&#39;m focused on building stunning responsive front-end web
              applications integrating back-end technologies.
            </p>
            <p className="py-4 text-gray-600 sm:max-w-[70%] m-auto text-lg">
              I also have strong knowledge of microservices, SQL, Git, setup
              source code and other coding topics.
            </p>
          </div>
